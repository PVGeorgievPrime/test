...
import 'package:liquidtools/assets.dart';
import 'package:liquidtools/base/theme/design_system.dart';
import 'package:liquidtools/base/theme/liquidtools_theme.dart';
import 'package:liquidtools/l10n/liquidtools_app_i18n.dart';
  ...
  Themes? theme,
    ...
    pumpDeviceBuilderWithMaterialApp(
      ...
      theme: theme == Themes.light
          ? LiquidtoolsTheme.buildTheme(DesignSystem.light())
          : LiquidtoolsTheme.buildTheme(DesignSystem.dark()),
    );
