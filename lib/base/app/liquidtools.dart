...
import '../../assets.dart';
import '../../l10n/liquidtools_app_i18n.dart';
...
import '../di/liquidtools_with_dependencies.dart';
import '../theme/design_system.dart';
import '../theme/liquidtools_theme.dart';
...
class Liquidtools extends StatelessWidget {
  const Liquidtools({
  ...
  @override
  Widget build(BuildContext context) => LiquidtoolsWithDependencies(
        config: config,
...
class __MyMaterialAppState extends State<_MyMaterialApp> {
  ...
  Widget _buildMaterialApp(BuildContext context) => MaterialApp.router(
        title: 'Liquidtools',
        theme: LiquidtoolsTheme.buildTheme(DesignSystem.light()),
        darkTheme: LiquidtoolsTheme.buildTheme(DesignSystem.dark()),
